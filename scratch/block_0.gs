...
{"step_index":272,"source":"MODEL","type":"PLANNER_RESPONSE","status":"DONE","created_at":"2026-05-07T07:27:13Z","content":"根據您的需求，我已更新了 Apps Script 的匯入邏輯。本次更新重點在於**非破壞性的欄位更新**，確保只有當 CSV 中的欄位 N 與 O 包含有效數值時，才會更新 Google Sheets 中的 BD 與 BE 欄位，否則將保留舊值。

### 1. 更新後的 Apps Script 程式碼 (核心邏輯)

請將以下邏輯整合進您的 `importStockCSV` 函數中：
